...
var filters = exports.filters = __webpack_require__(69);
...
if ((void 0)) {
  (void 0)['.ejs'] = function(module, filename) {
    source = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"fs\""); e.code = 'MODULE_NOT_FOUND';; throw e; }())).readFileSync(filename, 'utf-8');
    module._compile(compile(source, {}), filename);
  };
} else if (!(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND';; throw e; }()).registerExtension) {
  !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND';; throw e; }()).registerExtension('.ejs', function(src) {
    return compile(src, {});
  });
}
